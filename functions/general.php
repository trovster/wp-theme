...
function _site_get_nav_item($key, $value = null) {
	$navigation = _site_get_navigation(false);
...
/**
 * _site_init_remove_rsd
 * @desc	Remove the XML/RSD links from the header
 * @see		http://digwp.com/2009/06/xmlrpc-php-security/
 */
function _site_init_remove_rsd() {
	remove_action('wp_head', 'rsd_link');
	remove_action('wp_head', 'wlwmanifest_link');
}
add_action('init', '_site_init_remove_rsd');