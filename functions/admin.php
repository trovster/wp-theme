...
function _site_admin_action_admin_init_scripts() {
	...
	wp_register_script('admin-custom', get_stylesheet_directory_uri() . '/js/app/run.admin.js', array('jquery', 'admin-app', 'jquery-ui-core', 'jquery-ui-datepicker', 'wp-color-picker'), '1.0', true);
